...
This project is indexed by GitNexus as **TradingAgents** (1390 symbols, 2285 relationships, 60 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
